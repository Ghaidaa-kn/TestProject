            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li>
                            <a href="/users"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Users</span></a>
                        </li>
                        <li>
                            <a href="/products"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Products</span></a>
                        </li>
                        <li>
                            <a href="/users_products"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Users Products</span></a>
                        </li>
                        <li>
                            <a href="/add_product_view"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Add products</span></a>
                        </li>
                        <li>
                            <a href="/users_requests"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Registration Req</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/user_app/{{session('user')['id']}}"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">My Profile</span></a>
                        </li>
                        <li>
                            <a href="/edit_user_products/{{session('user')['id']}}"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">My products</span></a>
                        </li>
                        <li>
                            <a href="/change_password_view"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Change Password</span></a>
                        </li>
                        @endif
                    </ul>
                </div>
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    <li class="hidden-xs"><a href="#" class="add-project" data-toggle="modal" data-target="#add_project">{{session('user')['first_name']}}</a></li>
